...
//   return (
//     <>
//       <div className="Navbar text-dark-text dark:text-light-text">
//         {/* logo */}
//         <a href="#">
//           <img
...
//             <Button text={"Contact Us"} icon={icons.arrowRightIcon} />
//           </span>
...
//           >
//             {isSidebarOpen ? (
//               <IconComponent.closeIcon className="w-8 h-8" />
//             ) : (
//               <IconComponent.menuIcon className="w-8 h-8" />
//             )}
//           </button>
...
//       {/* Mobile Navbar */}
//       <div className="top-18 z-10 sticky">
//       {isSidebarOpen && <MobileNavbar isOpen={isSidebarOpen} />}
//       </div>
//     </>
//   );
// };
...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <>
      <div ref={navbarRef} className="Navbar text-dark-text dark:text-light-text">
        {/* logo */}
        <a href="#">
          <img
            src={theme === "dark" ? assets.lightLogo : assets.darkLogo}
